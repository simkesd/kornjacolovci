kornjacolovciApp.factory('FactoryTest', ['$resource', function($resource){
	return $resource("", {}, {
		...
		getRequestList : { url : '/requests/', params: {}, method: 'GET',  timeout : 5000, isArray:true},
		getMyRequests : {url: '/requests/mine', params: {user_id: "@user_id" }, method: 'GET', timeout: 5000, isArray: true }
	});
}]);
