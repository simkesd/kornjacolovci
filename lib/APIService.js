...
var APIService = (function() {
    ...
    function sell_offers(req, res) {
        var id = req.params.id;
        if(id) {
            query('SELECT sell_offer.*, a.name as animal_name from sell_offer LEFT JOIN animal as a on a.ID = sell_offer.animal_ID where sell_offer.ID = ?', [id], res);
        }else {
            query('SELECT sell_offer.*, a.name as animal_name from sell_offer LEFT JOIN animal as a on a.ID = sell_offer.animal_ID', [], res);
        }
    }
