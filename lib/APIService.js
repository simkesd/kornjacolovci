...
var APIService = (function() {
    ...
    function sell_offersAdd(req, res) {
        query('INSERT INTO sell_offer (animal_id, weight, quantity, place, transport) VALUES (?, ?, ?, ?, ?)', [req.body.animal_id, req.body.weight, req.body.quantity, req.body.place, req.body.transport], res);
    }
